...
import NotificationDropdown, { INITIAL_NOTIFICATIONS } from './NotificationDropdown';
    ...
    <>
      <header className="glass-surface rounded-2xl px-4 flex items-center gap-3 flex-shrink-0 h-14">
        ...
        <button
          ...
          className="md:hidden min-h-[44px] min-w-[44px] flex items-center justify-center rounded-lg text-neutral-500 hover:bg-white/10 hover:text-neutral-700 transition-all duration-200 flex-shrink-0 focus-ring"
        >
        ...
        <button
          ...
          className="relative min-h-[44px] min-w-[44px] flex items-center justify-center rounded-lg text-neutral-500 hover:bg-white/10 hover:text-neutral-700 transition-all duration-200 focus-ring flex-shrink-0"
        >
