    ...
    <header className="h-16 bg-white border-b border-neutral-200 flex items-center justify-between px-4 sm:px-6 flex-shrink-0">
      ...
      <div className="flex items-center gap-1">
        ...
        <button
          ...
          className="w-9 h-9 rounded-full bg-brand-600 flex items-center justify-center text-white text-sm font-semibold hover:bg-brand-700 transition-colors ml-1"
        >
          P
        </button>
      </div>
