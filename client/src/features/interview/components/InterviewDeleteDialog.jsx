  ...
  return (
    <div className="modal-overlay">
      ...
      >
        ...
        <h2 className="text-base font-semibold mb-2" style={{ color: '#e4e4e7' }}>Delete Interview</h2>
        <p className="text-sm leading-relaxed mb-6" style={{ color: '#71717a' }}>
          ...
          {interview.company && (
            <> at <span className="font-semibold" style={{ color: '#a1a1aa' }}>{interview.company}</span></>
          )}
